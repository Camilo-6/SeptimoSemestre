...
public class RunnableSC<T> implements Runnable{
	private int item;
	ConcurrentLinkedQueue<Integer> queue;
	SimpleSnapshotHC<String> snapshotI;
	SimpleSnapshotHC<String> snapshotR;
    private int num;
    public RunnableSC(int item, ConcurrentLinkedQueue<Integer> queue, 
    		int num, SimpleSnapshotHC<String> snapshotI, SimpleSnapshotHC<String> snapshotR){
        this.item = item;
        this.queue = queue;
