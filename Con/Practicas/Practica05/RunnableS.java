...
public class RunnableS<T> implements Runnable{
	private int item;
	ConcurrentLinkedQueue<Integer> queue;
	SimpleSnapshotH<String> snapshotI;
	SimpleSnapshotH<String> snapshotR;
    private int num;
    public RunnableS(int item, ConcurrentLinkedQueue<Integer> queue, 
    		int num, SimpleSnapshotH<String> snapshotI, SimpleSnapshotH<String> snapshotR){
        this.item = item;
        this.queue = queue;
