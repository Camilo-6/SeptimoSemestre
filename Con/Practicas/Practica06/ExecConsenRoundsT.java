...
public class ExecConsenRoundsT {
    public static int[] winners;
    public static void task(CountDownLatch latch, CASConsensusT<Integer> cas, int c, int round){
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < rounds; j++) {//Iteras en el no. de rondas
            ...
            CASConsensusT<Integer> protocolCAS = new CASConsensusT<Integer>(c, -1);
            int currRound = j;
